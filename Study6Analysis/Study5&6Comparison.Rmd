...
```{r}
FullWHNPptDataset$Block <- relevel(FullWHNPptDataset$Block, ref = "Control")
...
print("***************Control - Control 2***************")
ControlConfGLM <- lm(data = ControlData, conf_slider.response ~ Study, family = "poisson")
summary(ControlConfGLM)
...
RoSASANOVA <- aov(data = FullRoSAS, formula = Capable ~  Block)
summary(RoSASANOVA)
TukeyHSD(RoSASANOVA)
