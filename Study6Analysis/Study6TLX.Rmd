...
# Tidy the data - select scores,
  ...
  TLXdataOrg$Block[TLXdataOrg$Block == "Level 1 - Bar"] <- "Visual Cue"
  TLXdataOrg$Block[TLXdataOrg$Block == "Level 2 - Avatar"] <- "Avatar Cue"
  TLXdataOrg$Block[TLXdataOrg$Block == "Level 3 - SocAvatar"] <- "Social Cue"
...
TLXdataOrg$Block <- factor(TLXdataOrg$Block, levels = c("Control - 2", "Visual Cue", "Avatar Cue", "Social Cue"))
...
#TLXdata$Block <- factor(TLXdata$Block, levels = c("Control - 2", "Visual Cue", "Avatar Cue", "Social Cue"))


S6TLX <- ggplot(TLXdata, aes(Block, Total, fill = Block ))+
