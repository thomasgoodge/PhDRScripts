...
# Tidy the data - select scores,
  ...
  TLXdataOrg$Block[TLXdataOrg$Block == "Level 3 - SocAvatar"] <- "Social"
...
TLXdataOrg$Block <- factor(TLXdataOrg$Block, levels = c("Control", "Visual", "Avatar", "Social"))


  TLXdataOrg <- TLXdataOrg %>% 
  subset(participant != "SP10") %>% 
    subset(participant != "SP12") %>% 
        subset(participant != "SP08") 
