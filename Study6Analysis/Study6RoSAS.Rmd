...
TLXdataOrg$Block <- relevel(TLXdataOrg$Block, ref = "Control")
...
RoSASOrg$Block <-  factor(RoSASOrg$Block, levels = c("VisualCue", "AvatarCue", "SocialCue"))
...
write.csv(RoSASFull, "C:/Users/thoma/OneDrive - University of Glasgow/Desktop/Study 6/ComparisonData/S6RoSAS.csv", row.names=FALSE)
...
```{r}
# Social
RosasSoc.aov <- anova_test(data = RoSASFull, dv = Social, wid = participant, within = Block)
