...
ConfNullModel <- glmer(data = WHNDataset, formula = conf_slider.response ~  (1|participant) + (1|image_file), family = binomial, glmerControl(optimizer = "bobyqa"))

ConfModelPpt <-  glmer(data = WHNDataset, formula = conf_slider.response ~ Block + (1|participant),family = binomial , glmerControl(optimizer = "bobyqa"))

ConfModelClip <-  glmer(data = WHNDataset, formula = conf_slider.response ~ Block +(1|image_file),family = binomial, glmerControl(optimizer = "bobyqa"))
