...
setwd("K:/PsychoPyExperiments/Study 2 Clips")

#Define the filepath for where the data is coming from
dataFolder <- "K:/Road Footage/PavloviaData/data"
...
demogs <- group_by(datasetRaw, idx, Age.Years..months..) %>% 
summarise(Age = Age.Years..months.. > 75,
          idx = idx)
...
datasetHazardWideSummary <- datasetHazardWide %>% 
  ...
  mutate(AcceptReject = (ifelse(PercentageResponses >= 90, 1, 0)))
```
