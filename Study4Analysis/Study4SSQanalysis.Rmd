...
SSQdata[SSQdata== 'Start of Experiment'] <- '1'
...
SSQdata$Block <-if_else(SSQdata$Timepoint == "5", SSQdata$Fourth,
                                  if_else(SSQdata$Timepoint == "4", SSQdata$Third,
                                          if_else(SSQdata$Timepoint == "3", SSQdata$Second,
                                                  if_else(SSQdata$Timepoint == "2", SSQdata$First, 
                                                          if_else(SSQdata$Timepoint == "1",'Baseline', 'Baseline')))))
...
#SSQConversion$DisorientationSum <- colSums(SSQConversion[, c("Difficulty Focusing","Nausea", "Fullness of Head", "Blurred Vision","Dizzy (Eyes Open)","Dizzy ( Eyes Closed)", "Vertigo")])
...
anova(TotalSSQmodel1, TotalSSQmodel2, TotalSSQmodel3, TotalSSQmodel4,TotalSSQmodel5)
