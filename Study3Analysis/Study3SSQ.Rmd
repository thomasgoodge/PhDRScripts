...
anova(TotalSSQmodel1, TotalSSQmodel2, TotalSSQmodel3, TotalSSQmodel4,TotalSSQmodel5,TotalSSQmodelTPRBlock)
...
SSQConversion$Timepoint <- relevel(SSQConversion$Timepoint, ref = "6")
TotalSSQmodel2 <- lmer(data = SSQConversion, TotalSSQScore ~Timepoint + Block + (1|participant), REML = F)

summary(TotalSSQmodel2)

TotalSSQresults <- report(TotalSSQmodel2, CI = 95)
...
TotalKPSSQmodel4 <- lmer(data = SSQKPConversionTotalSSQ, TotalSSQScoreChange ~ Block + (1|participant),REML = F)

anova(TotalKPSSQNullmodel, TotalKPSSQmodel1, TotalKPSSQmodel2, TotalKPSSQmodel3,TotalKPSSQmodel4)

anova(TotalKPSSQmodel1, TotalKPSSQmodel4)
...
SSQKPConversionTotalSSQ$Timepoint <- relevel(SSQKPConversionTotalSSQ$Timepoint, ref = "T4")
