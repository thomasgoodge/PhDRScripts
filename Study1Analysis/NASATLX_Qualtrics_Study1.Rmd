...
#Read in the data
TLXdataRaw <- read.csv("D:/Study1Data/Qualtrics_Data/Study1/NASATLX/TGExp1NasaTLX.csv") %>%
...
TLXdataOrg[,2] = toupper(TLXdataOrg[,2]) %>% 
  ...
  TLXdataOrg[TLXdataOrg == "Control"] <- "Go/NoGo"
  TLXdataOrg[TLXdataOrg == "Experiment"] <- "Go/NoGo-AR"
```
...
ggsave(S1TotalTLX, filename = "S1TotalTLX.png")
...
anova(TLXMentalmodel2, TLXMentalmodel)
...
anova(TLXPhysmodel2, TLXPhysmodel)

summary(TLXPhysmodel)

Physresults <- report(TLXPhysmodel, CI = 95)
