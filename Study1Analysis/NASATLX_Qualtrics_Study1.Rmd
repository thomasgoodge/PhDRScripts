...
#Read in the data
TLXdataRaw <- read.csv("C:/Users/thoma/OneDrive - University of Glasgow/Desktop/Study 1/RTData/TGExp1NasaTLX.csv") %>%
...
ggplot(TLXdata, aes(Condition, Total, fill = Block ))+
  ...
  #ylim(0,100)+
  labs(title = "Total TLX Score")+
    scale_fill_manual(values = Blended_Palette)
