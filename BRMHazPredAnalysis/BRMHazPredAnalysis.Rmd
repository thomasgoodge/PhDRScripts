...
```{r}
ScoreGLMER <- glmer(family = "binomial", data = FullDataset, formula = trialrespkey.corr ~ Group + (1|ProlificID))
summary(ScoreGLMER)


ScoreGLMERLicense <- glmer(family = "binomial", data = FullDataset, formula = trialrespkey.corr ~ Group + UKLicense + (1|ProlificID))
